...
The [repo map](../aider/website/docs/repomap.md) shows *definitions*. It does
not show how they connect, so a model often cannot tell where something
actually happens and guesses which files to ask for.
...
Website copy: [Tracing code](../aider/website/docs/usage/tracing.md).
